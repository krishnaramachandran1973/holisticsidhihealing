      ...
      .eventually {
        CompletableFuture.supplyAsync {
          subscription.to(subscriber.email)
            ...
            .data("title", "HolisticSidhiHealing")
            .data("header", "Welcome to HolisticSidhiHealing.com!")
            .data("domain", "HolisticSidhiHealing")
            .data("name", subscriber.name)
            .data("description", "Thank you for subscribing to HolisticSidhiHealing.com. You will be notified of any upcoming sessions or blogs. Meanwhile please go through the\n" +
              "          various testimonials, blogs and consultation types.")
